...
┌─────────────────────────────────────────────────────────────────────┐
│                    通用型经济管理类文献综述Skill v5.0.0                │
├─────────────────────────────────────────────────────────────────────┤
│  📌 定位：任何经济管理领域研究主题均可直接使用                          │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  🎯 核心功能                                                         │
│  ├── 1. 文献质量检查（期刊评级标准）                                    │
...
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
维度	Literature-Reviewer-Skill (原版)	文献综述skill (我们定制版)
定位	通用型（任何学科）	专注经济管理类
文献质量	无筛选，只要检索到就行	B级及以上保底门槛
期刊评级	❌ 无	✅ 整合SWUFE评级标准
替换策略	❌ 无（只检索，不替换）	✅ 自动标记+搜索替代文献
综述生成	8阶段工作流，Phase 8有迭代评分机制	保留完整工作流
输出	references.md + literature_review.md	增加 literature_quality_report.md + papers_to_replace.md
触发方式	自然语言安装指令	固定触发关键词
CNKI限制	依赖browser skill，验证码无法绕过	明确标注需校园网认证
